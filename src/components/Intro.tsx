  ...
  return (
    ...
    >
      ...
      >
        ...
        Computer Systems Engineer Expert in AI & Blockchain.
      </motion.h1>
      <motion.div
      ...
      >
        ...
        <div className="flex gap-2 justify-center items-center">
          <a
            ...
            rel="noreferer noopener"
            className="border hover:text-gray-950 border-black/10 cursor-pointer outline-none focus:scale-110 hover:scale-110 active:scale-105 transition hover:bg-gray-50 bg-white text-gray-900 p-4 flex items-center justify-center w-[48px] h-[48px] rounded-full"
          >
            <BsLinkedin />
          </a>
